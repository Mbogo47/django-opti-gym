...
def home(request):
    ...
    trainers = models.Trainer.objects.all()[:3]  
    return render(request, 'home.html', {'banners': banners, 'services': services, 'gimgs': gimgs, 'trainers': trainers})
# PageDetail
...
stripe.api_key='sk_test_51NXfQOBCiKd3UnInkpHlYxX4JTYJR1j0NaVKgnJme5n9lib6WzBTIttlLWPIDkFdpuAcfAe7OhETYPKqJJl0umUh00xbB74plw'
...
def pay_success(request):
	...
	from_email='njokiivy47@gmail.com'
